 ...
 */
#ifndef __CRC16_KERMIT_H__
#define __CRC16_KERMIT_H__
...
#define CRC16_KERMIT_NUM_WIDTH "4"
#define CRC16_KERMIT_NUM_PRIx PRIx16
#define CRC16_KERMIT_NUM_PRIX PRIX16

#define CRC16_KERMIT_NUM_TYPE uint16_t
#define CRC16_KERMIT_DEFAULT_DATA "crc16_kermit.default"
#define CRC16_KERMIT_TABLE_DATA "crc16_kermit.table"
...
typedef struct {
    ...
    // data
    CRC16_KERMIT_NUM_TYPE polynomial;
    CRC16_KERMIT_NUM_TYPE initial_value;
    CRC16_KERMIT_NUM_TYPE final_xor_value;
    CRC16_KERMIT_NUM_TYPE accumulate;
    CRC16_KERMIT_NUM_TYPE cast_mask;
} CRC16_KERMIT;
