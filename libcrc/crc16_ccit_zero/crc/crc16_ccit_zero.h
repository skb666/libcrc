 ...
 */
#ifndef __CRC16_CCIT_ZERO_H__
#define __CRC16_CCIT_ZERO_H__
...
#define CRC16_CCIT_ZERO_NUM_WIDTH "4"
#define CRC16_CCIT_ZERO_NUM_PRIx PRIx16
#define CRC16_CCIT_ZERO_NUM_PRIX PRIX16

#define CRC16_CCIT_ZERO_NUM_TYPE uint16_t
#define CRC16_CCIT_ZERO_DEFAULT_DATA "crc16_ccit_zero.default"
#define CRC16_CCIT_ZERO_TABLE_DATA "crc16_ccit_zero.table"
...
typedef struct {
    ...
    // data
    CRC16_CCIT_ZERO_NUM_TYPE polynomial;
    CRC16_CCIT_ZERO_NUM_TYPE initial_value;
    CRC16_CCIT_ZERO_NUM_TYPE final_xor_value;
    CRC16_CCIT_ZERO_NUM_TYPE accumulate;
    CRC16_CCIT_ZERO_NUM_TYPE cast_mask;
} CRC16_CCIT_ZERO;
