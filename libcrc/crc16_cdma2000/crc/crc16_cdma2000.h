 ...
 */
#ifndef __CRC16_CDMA2000_H__
#define __CRC16_CDMA2000_H__
...
#define CRC16_CDMA2000_NUM_WIDTH "4"
#define CRC16_CDMA2000_NUM_PRIx PRIx16
#define CRC16_CDMA2000_NUM_PRIX PRIX16

#define CRC16_CDMA2000_NUM_TYPE uint16_t
#define CRC16_CDMA2000_DEFAULT_DATA "crc16_cdma2000.default"
#define CRC16_CDMA2000_TABLE_DATA "crc16_cdma2000.table"
...
typedef struct {
    ...
    // data
    CRC16_CDMA2000_NUM_TYPE polynomial;
    CRC16_CDMA2000_NUM_TYPE initial_value;
    CRC16_CDMA2000_NUM_TYPE final_xor_value;
    CRC16_CDMA2000_NUM_TYPE accumulate;
    CRC16_CDMA2000_NUM_TYPE cast_mask;
} CRC16_CDMA2000;
