 ...
 */
#ifndef __CRC16_MCRF4XX_H__
#define __CRC16_MCRF4XX_H__
...
#define CRC16_MCRF4XX_NUM_WIDTH "4"
#define CRC16_MCRF4XX_NUM_PRIx PRIx16
#define CRC16_MCRF4XX_NUM_PRIX PRIX16

#define CRC16_MCRF4XX_NUM_TYPE uint16_t
#define CRC16_MCRF4XX_DEFAULT_DATA "crc16_mcrf4xx.default"
#define CRC16_MCRF4XX_TABLE_DATA "crc16_mcrf4xx.table"
...
typedef struct {
    ...
    // data
    CRC16_MCRF4XX_NUM_TYPE polynomial;
    CRC16_MCRF4XX_NUM_TYPE initial_value;
    CRC16_MCRF4XX_NUM_TYPE final_xor_value;
    CRC16_MCRF4XX_NUM_TYPE accumulate;
    CRC16_MCRF4XX_NUM_TYPE cast_mask;
} CRC16_MCRF4XX;
